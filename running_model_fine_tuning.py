...
BASE_MODEL_ID = r"C:\Users\igmartin\projects\liquid\LFM2-VL-450M"
ADAPTER_ID = r"C:\Users\igmartin\projects\liquid\lfm2-vl-450-fine-tuning"
...
/* --- NEW FLEXBOX STYLES FOR THE HEADER --- */
...
#header .header-text h1 {
    ...
    font-weight: 300; /* Optional: make the font a bit lighter */
}
"""
...
with gr.Blocks(title="LFM2-VL Enhanced", theme=gr.themes.Soft(), css=CUSTOM_CSS) as demo:
    ...
    <div class="header-container">
        ...
        <div class="header-text">
            <h1 style="margin: 0;">{MODEL_NAME} Vision-Language Model</h1>
        </div>
    </div>
...
if __name__ == "__main__":
    project_path = r"C:/Users/igmartin/projects/liquid"
    demo.queue().launch(allowed_paths=[project_path])