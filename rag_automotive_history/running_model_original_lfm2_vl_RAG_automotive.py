...
MODEL_NAME = "LFM2-VL-450M (Base Model) RAG Automotive history"
    ...
    try:
        ...
        if use_rag and (rag_index is not None):
            ...
            if search_results:
                ...
                rag_context = "Based on the provided document about the history of the automobile, here is some relevant context:\n"
                rag_context += "\n".join(context_texts)
                if retrieved_images:
        ...
        with gr.Row():
            ...
            with gr.Column():
                ...
                use_rag_checkbox = gr.Checkbox(
                    ...
                    label="📚 Use Document RAG (Search Automobile PDF)",
